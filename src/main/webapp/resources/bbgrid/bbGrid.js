...
(function () {
    ...
    bbGrid.Dict = {
        ...
        'ru': {
            ...
            noData: 'Ð�ÐµÑ‚ Ð·Ð°Ð¿Ð¸Ñ�ÐµÐ¹',
            search: 'ÐŸÐ¾Ð¸Ñ�Ðº',
            rowsOnPage: 'CÑ‚Ñ€Ð¾Ðº Ð½Ð° Ñ�Ñ‚Ñ€Ð°Ð½Ð¸Ñ†Ðµ',
            all: 'Ð’Ñ�Ðµ',
            page: 'Ð¡Ñ‚Ñ€',
            prep: 'Ð¸Ð·'
        }
    ...
    _.extend(bbGrid.View.prototype, Backbone.View.prototype, {
        ...
        render: function () {
            ...
            if (!this.$navBar) {
                ...
                this.$loading = $('<div class="bbGrid-loading progress-bar progress-bar-info progress-striped active"><div class="progress-bar bbGrid-loading-progress">' + this.dict.loading + '</div></div>');
    ...
    _.extend(bbGrid.SearchView.prototype, Backbone.View.prototype, {
        ...
        template: _.template(
            '<div class="input-append">\
                <input name="search" class="" type="text" placeholder="<%=dict.search%>">\
