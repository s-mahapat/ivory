...
--* UPGRADE "1.1.1" --> "1.1.2" 
--* SECTION "Creating table DOCTORS"
...
ALTER TABLE doctors ADD KEY indx_mobile (`mobile`);
ALTER TABLE doctors ADD KEY indx_email (`email`);
ALTER TABLE doctors ADD KEY indx_name (`first_name`, `last_name`);

--* /UPGRADE


--* UPGRADE "1.1.2" --> "1.1.3" 
--* SECTION "Creating table APPOINTMENTS"
...
CREATE TABLE APPOINTMENTS (
  ...
  APPOINTMENTREASON varchar(30),
  APPOINTMENTREMARKS varchar(30),
  PRIMARY KEY (`ID`)
);
